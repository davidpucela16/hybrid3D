...
from hybrid_set_up_noboundary_optimized import hybrid_set_up, visualization_3D
...
if __name__ == '__main__':
    ...
    cProfile.run('prob.Assembly_B_optimized()', filename=path + '/profile_results.prof')

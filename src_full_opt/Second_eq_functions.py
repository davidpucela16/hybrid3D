...
# =============================================================================
# @njit
# def InterpolatePhiBarFast(n, cells_x, cells_y, cells_z, h_3D,  
...
#     for j in np.arange(50000,51000):
#         if not j%500: 
#             print("Assembling D and E, source_3: ", j)
...
# @njit
# def InterpolatePhiBarFast_2(n, cells_x, cells_y, cells_z, h_3D, 
#                              pos_cells,s_blocks, source_edge,tau_array, pos_s, h_1D, R, D):
#     """Perform the loop in C that loops over the whole network"""
#     kernel_s_array=List()
#     kernel_q_array=List()
...
#     
#     #for j in range(len(s_blocks)):
#     for j in np.arange(50000,50500):
#         if not j%500: 
#             print("Assembling D and E, source_3: ", j)
#         kernel_s,col_s,kernel_q, col_q=InterpolateFast(pos_s[j], n, cells_x, cells_y,
#                               cells_z, h_3D, GetBoundaryStatus(pos_s[j],h_3D, cells_x, cells_y, cells_z), pos_cells,s_blocks, source_edge,
...
#         
#     return(kernel_s_array, col_s_array, kernel_q_array, col_q_array)
# 
# @njit
# def InterpolatePhiBarFast_3(n, cells_x, cells_y, cells_z, h_3D, 
...
#             print("Assembling D and E, source_3: ", j)
#             print("c_q=", c_q)
#             print("max_size*len(s_blocks)=", max_size*len(s_blocks))
#         kernel_s,col_s,kernel_q, col_q=InterpolateFast(pos_s[j], n, cells_x, cells_y,
#                               cells_z, h_3D, GetBoundaryStatus(pos_s[j],h_3D, cells_x, cells_y, cells_z), pos_cells,s_blocks, source_edge,
#                               tau_array, pos_s, h_1D, R, D)
#         
...
def RetrievePhiBar(mat_path, S, size_mesh, uni_s_blocks):
    ...
    for i in uni_s_blocks:
        ...
        if c%200==0 or c==len(uni_s_blocks):

...
search_phrases=("InterpolatePhiBarBlock" "Fast" "AppendSparse" "TrilinearInterpolation" "FromBoundaryGetNormal")
# Array of replacement phrases
replacement_phrases=("InterpolatePhiBarBlock" "Fast" "AppendSparse" "TrilinearInterpolation" "FromBoundaryGetNormal")

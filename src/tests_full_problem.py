...
pos_vertex=np.array([[L[0]/2, L[0]/2, L[0]/2-0.5],[L[0]/2,L[0]/2, L[0]/2+0.5]])
...
plt.imshow(sol[l[1]].reshape(cells, cells), origin="lower"); plt.colorbar()
...
prob.s=sol
prob.q=q
a,b=prob.get_coord_reconst(np.array([[0.5,0.5,4.5],[0.5,8.5,4.5],[8.5,0.5,4.5],[8.5,8.5,4.5]]), res)

#%%
plt.imshow(b.reshape(res,res))
plt.colorbar()
#%%
